...
## Corpus Check
- 232 files · ~176,390 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1442 nodes · 2430 edges · 95 communities (75 shown, 20 thin omitted)
- Extraction: 94% EXTRACTED · 6% INFERRED · 0% AMBIGUOUS · INFERRED: 134 edges (avg confidence: 0.84)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c13dd357`
...
Cohesion: 0.07
Nodes (33): TooltipContent, allFolderPaths, devMockService, dummyFolders, folderNameMap, imageFolders, FolderList(), FolderListLoadMore() (+25 more)
...
Cohesion: 0.15
Nodes (25): fileMenu, MenuItemData, renderMenuItems(), viewMenu, Button(), buttonVariants, Menubar(), MenubarCheckboxItem() (+17 more)
...
Cohesion: 0.11
Nodes (14): initialState, Theme, ThemeProvider(), ThemeProviderContext, ThemeProviderProps, ThemeProviderState, useTheme(), Toaster() (+6 more)
...
Cohesion: 0.07
Nodes (41): Arc, FolderThumbnailResult, ImageError, BatchResult, BatchTask, BatchThumbnailGenerator, Option, PathBuf (+33 more)
...
### Community 17 - "Hook Integration Tests"
Cohesion: 0.27
...
### Community 20 - "Component Test Mocks"
Cohesion: 0.11
Nodes (21): mockFolders, servicesContext, ServicesProvider(), basenameImpl(), convertFileSrcImpl(), createMockFileSystemService(), dirnameImpl(), mockBasename (+13 more)

### Community 21 - "Local Folder Container"
Cohesion: 0.05
Nodes (55): KeyboardShortcutHelp(), KeyboardShortcutHelpProps, createCustomKeyboardMapping(), createDefaultKeyboardMapping(), findShortcutConflicts(), getShortcutDescription(), getShortcutList(), createCustomKeyboardMapping() (+47 more)
...
### Community 23 - "Archive Image Container"
Cohesion: 0.21
...
### Community 26 - "Folder Image Container"
Cohesion: 0.22
...
Cohesion: 0.12
Nodes (25): Drop, Q, get_sibling_containers(), list_image_handles(), list_images_in_container(), resolve_images_in_range(), ImageHandle, P (+17 more)
...
### Community 39 - "useImages Hook & Tests"
Cohesion: 0.14
Nodes (11): App(), APP_VIEWER_CONTAINER_CONFIG, TODO: 状態管理が複雑化している。appStateでの管理に無理が生じ始めている。, TODO: App.tsx自体が肥大化してきている。状態管理とUIロジックの分離を検討。, ErrorBoundary, Props, State, useSiblingContainers() (+3 more)
...
### Community 42 - "Reader Config Rust"
Cohesion: 0.22
...
### Community 89 - "app-shell/index.ts"
Cohesion: 0.31
Nodes (10): React, AppMenuBar(), AppMenuBarProps, HeaderMenu(), MenuDropdown(), MenuItem(), HeaderMenuProps, MenuAction (+2 more)

### Community 90 - "useSiblingContainers.ts"
Cohesion: 0.38
...
- **Why does `React` connect `app-shell/index.ts` to `UI Tooltip & Dev Mocks`, `App Menu & Folder Navigation`, `Biome Lint Config`, `App Shell State`, `useImages Hook & Tests`, `Component Test Mocks`, `Local Folder Container`, `useSiblingContainers.ts`?**
  _High betweenness centrality (0.038) - this node is a cross-community bridge._
- **Why does `globals` connect `Biome Lint Config` to `app-shell/index.ts`?**
